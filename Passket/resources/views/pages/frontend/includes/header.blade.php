...
<!-- header-section - start
	================================================== -->
	<header id="header-section" class="header-section sticky-header-section not-stuck clearfix nav-bar">
		<!-- header-bottom - start -->
					...
					<div class="col-lg-3">
						<div class="site-logo-wrapper">
							<a href="index-1.html" class="logo">
								...
								<h1 class="header-logo">Passket</h1>
							</a>
						</div>
					</div>
													...
													<div class="overlay-black clearfix">
														...
														<div class="leftside-content">
															...
															<div class="copyright-text">
																<p class="m-0">©2018 <a href="#!" class="yellow-color">Passket.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
															</div>
														</div>
