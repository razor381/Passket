				...
				<div class="row">
					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="leftside-wrapper">
							<h3 class="white-color">Event starts in <br> <strong class="white-color">within 12:00 Minutes.</strong></h3>
									...
									<li class="rt-body">
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">Passket Package 1</h3>
										...
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">Passket Package 2</h3>
												<span class="ticket-price">$120.00 + FEE $5.00</span>
											</div>
											<div class="rightside-content">
												<div class="ticket-select">
										...
										<div class="rt-body-item">
											<div class="leftside-content">
												<h3 class="ticket-title">Passket Package 3</h3>
												<span class="ticket-price">$120.00 + FEE $5.00</span>
											</div>
											<div class="rightside-content">
												<div class="ticket-select">
