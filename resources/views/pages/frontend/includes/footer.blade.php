			...
			<div class="row">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="basic-info-item">
									...
									<div class="info-content">
										<p><a href="#!">contact@passket.com</a></p>
										<h3><a href="#!">info@passket.com</a></h3>
									</div>
								</div>
							</div>
							<!-- basic-info-item - end -->
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="instagram-wrapper ul-li">
						<h3 class="footer-item-title">
							Passket <strong>instagram</strong>
						</h3>
						<ul>
						...
						<h4 class="followus-link">
							Follow Our Instagram <a href="#!">#Passket</a>
						</h4>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-12 col-sm-12">
					<div class="copyright-text">
						<p class="m-0">©2018 <a href="#!" class="site-link">Passket.com</a></p>
					</div>
				</div>
				<!-- copyright-text - end -->
